...
import { FileText, LayoutDashboard, Menu, Package, Tag, Users, X } from 'lucide-react';
import { useState } from 'react';
import ChatWidget from '@/components/ChatWidget';

// ⚡ Customize these for your app
const APP_TITLE = 'Störungsmanagement';
const APP_SUBTITLE = 'MKK2 Anlagen';

const navigation = [
  { name: 'Übersicht', href: '/', icon: LayoutDashboard },
  { name: 'Mitarbeiter', href: '/mitarbeiter', icon: Users },
  { name: 'Produktionsbereich', href: '/produktionsbereich', icon: Package },
  { name: 'Anlagenteiltyp', href: '/anlagenteiltyp', icon: Tag },
  { name: 'Anlage', href: '/anlage', icon: FileText },
  { name: 'Anlagenteil', href: '/anlagenteil', icon: FileText },
  { name: 'Baugruppe', href: '/baugruppe', icon: FileText },
  { name: 'Störungsmeldung', href: '/stoerungsmeldung', icon: FileText },
  { name: 'Korrespondenz', href: '/korrespondenz', icon: FileText },
  { name: 'Nachrichten', href: '/nachrichten', icon: FileText },
        ...
        <div className="flex items-center justify-between px-5 py-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-sidebar-primary flex items-center justify-center shadow-sm">
              <Users size={16} className="text-sidebar-primary-foreground" />
            </div>
            <div>
